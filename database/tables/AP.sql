...
('fields_created', 1250, 1.000, 'Building'),
('fields_destroyed', 750, 1.000, 'Destroying'),
('links_created', 313, 1.000, 'Building'),
('links_destroyed', 187, 1.000, 'Destroying'),
('portals_captured', 500, 1.000, 'Building'),
('portals_discovered', 1000, 1.000, 'Misc'),
('portals_neutralized', 0, 1.000, 'Destroying'),
('res_destroyed', 75, 1.000, 'Destroying'),
('xm_recharged', 10, 0.001, 'Misc');
